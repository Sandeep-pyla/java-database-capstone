...
function renderHeader() {
    ...
    function attachHeaderButtonListeners() {
        ...
        document.getElementById("adminBtn").addEventListener("click", () => openModal("loginAdmin"));
        document.getElementById("patientLogin").addEventListener("click", () => openModal("loginPatient"));
        document.getElementById("patientSignup").addEventListener("click", () => openModal("signupPatient"));
